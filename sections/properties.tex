...
Additionally, we show that the normalisation semantics is a big-step semantics. \fixme{Alejandro: ?}
...
Lemma~\ref{lem:presvalue} and Lemma~\ref{thm:pres-stride} are proven in the
