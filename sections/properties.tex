...
\todo{the judgement about well-formed states $\Gamma, \Sigma |- \sigma$ should include the $\Gamma$ or not? Because in the other occurrences of the judgement $\Gamma$ is not included. However, when you explain what the judgement means (line 1051) you use the $\Gamma$.}
