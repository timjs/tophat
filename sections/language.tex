...
\todo{Say someting about why we need beta, and use beta in the acutal typing rule}
\todo{Alejandro: Is there anything surprising? Say what}
...
This means users cannot work on the branches of an external choice before picking one. \todo{Alejandro: Is this actually implied?}
