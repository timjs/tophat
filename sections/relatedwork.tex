...
Functional Reactive Programming (FRP) is a paradigm to describe graphs of values, called behaviors, that depend on each other and on external events.
...
There are some concepts that are similar in \TOP and FRP.
The \emph{stepper} behavior is associated with an event and yields the value of the most recent event.
