...
\ITASKS implicitly has a formal semantics, inherited from the graph-rewriting semantics of Clean.
This semantics however does not lend itself well for formal reasoning.
