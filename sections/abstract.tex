...
Current languages and frameworks are limited in flexibility and lack a good level of abstraction. \fixme{Rinus: het is vast waar, maar ik zou het iets zachter formuleren: focus op een concreet toepassingsgebied, maar minder op ...}
...
So far, it has not been given a formalization in the style common in programming language research. \fixme{Rinus: not been given a formalization which is very suitable for formal reasoning.}
