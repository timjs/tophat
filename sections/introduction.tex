...
By separating them in the style of a deep embedding \cite{conf/cefp/Gibbons13}, we make explicit where and where not, they depend on each other. \fixme{what to do with this sentence}
...
and describe their similarities and differences.\fixme{What do you mean with this sentence?}
...
\begin{itemize}
  ...
  \item
    We have implemented \TOPHAT in iTasks to demonstrate that the first is a subset of the second.

  \item
    Using both informal and formal descriptions, we compare \TOP with multiple related works in areas,
