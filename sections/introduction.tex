...
\todo{Alejandro: The introduction seems to be more about why Task-Oriented Programming
...
\todo{Alejandro: Not entirely convincing}%Nico: hij heeft het hier volgens mij over de titel van de sectie en het woord aims in de eerste zin. Misschien moeten we een hardere claim doen hier?
...
\todo{Should this be mentioned earlier?}
...
\Cref{sec:intuition} gives an overview of the essential concepts of \TOP and \TOPHAT.
