...
\todo{you mention S-AND before having introduced the striding semantics (perhaps add a reference to the figure where this rule appears).}
...
\end{figure}
\todo{when you write $v' : \tau$ (in the set comprehensions) I assume the intention is to say any input value of type $\tau$. I would write it as ${v' | v' : \tau}$.}
