...
\todo{Alejandro: In the formalization you show quite some figures. I think that for
...
\end{figure}
\todo{Alejandro over tasks: I was not expecting these to be values...}
...
They are given in the appendix. \todo{Alejandro: What is interesting about them?}
...
\todo{The example is not 100\% clear to me}
