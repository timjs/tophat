...
To model collaboration, one needs communication, concurrency, and synchronisation. \fixme{Alejandro: Is this a basic calculus to why iTasks is elaborated?} %nico: not sure what he means here...
