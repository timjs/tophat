...
\subsubsection*{Tasks model collaboration}
...
\subsubsection*{Tasks are reusable}
...
\subsubsection*{Tasks are driven by user input}
...
\subsubsection*{Tasks can be observed}
...
\subsubsection*{Tasks are never done}
...
\subsubsection*{Tasks can share information}
...
\subsubsection*{Tasks are predictable}
